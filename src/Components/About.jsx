        ...
        <div className="container">
          ...
          <div className='about__data' data-aos="fade-down">
            ...
            <ul>
              ...
              <li><p><strong>Year : </strong>2.2(Sophmore)</p></li>  
            </ul>
          </div>
